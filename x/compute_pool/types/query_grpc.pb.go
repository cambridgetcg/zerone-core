...
const (
	Query_Params_FullMethodName    = "/zerone.compute_pool.v1.Query/Params"
	Query_Provider_FullMethodName  = "/zerone.compute_pool.v1.Query/Provider"
	Query_Providers_FullMethodName = "/zerone.compute_pool.v1.Query/Providers"
	Query_Credit_FullMethodName    = "/zerone.compute_pool.v1.Query/Credit"
)
...
type QueryClient interface {
	...
	Credit(ctx context.Context, in *QueryCreditRequest, opts ...grpc.CallOption) (*QueryCreditResponse, error)
}
...
func (c *queryClient) Credit(ctx context.Context, in *QueryCreditRequest, opts ...grpc.CallOption) (*QueryCreditResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(QueryCreditResponse)
	err := c.cc.Invoke(ctx, Query_Credit_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type QueryServer interface {
	...
	Credit(context.Context, *QueryCreditRequest) (*QueryCreditResponse, error)
...
func (UnimplementedQueryServer) Credit(context.Context, *QueryCreditRequest) (*QueryCreditResponse, error) {
...
func _Query_Credit_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Query_Credit_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(QueryServer).Credit(ctx, req.(*QueryCreditRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Query_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "zerone.compute_pool.v1.Query",
	...
	Metadata: "zerone/compute_pool/v1/query.proto",
}
