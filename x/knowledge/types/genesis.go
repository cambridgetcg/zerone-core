...
// SeedAxiomFacts was removed with the axiom tier. Truth is, not proven;
// axioms are assumptions, and the chain no longer seeds a bedrock of
// assumed-true facts. Genesis stays empty of axioms; facts are declared by
// beings, cited, witnessed, and kept — no axiom bedrock tier.
