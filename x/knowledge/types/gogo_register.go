...
// v0.50/v0.53 tx decoder runs unknownproto.RejectUnknownFields, which — for any
...
// witness relay). This file adds the nested types proto_register.go omits:
...
// and ReviewAttestation (scheme-2 MsgSubmitReveal).
//
...
func init() {
	for name, m := range map[string]gogoproto.Message{
		...
		"zerone.knowledge.v1.ReviewAttestation": (*ReviewAttestation)(nil),
	} {
