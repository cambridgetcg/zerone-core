...
// ComputationalCommitment anchors externally executed work without placing
// raw artifacts, private evidence, or execution transcripts on chain. Every
// field is a bare, lowercase, 64-character SHA-256 hex digest. The work,
// acceptance, input, and environment commitments bind the result to the
// sponsor's declared contract; the remaining roots make the produced artifact
// and its evidence independently retrievable and auditable.
type ComputationalCommitment struct {
	state           protoimpl.MessageState `protogen:"open.v1"`
	...
	EvidenceRoot    string                 `protobuf:"bytes,6,opt,name=evidence_root,json=evidenceRoot,proto3" json:"evidence_root,omitempty"`
	WorkReceiptHash string                 `protobuf:"bytes,7,opt,name=work_receipt_hash,json=workReceiptHash,proto3" json:"work_receipt_hash,omitempty"`
	unknownFields   protoimpl.UnknownFields
	sizeCache       protoimpl.SizeCache
}

func (x *ComputationalCommitment) Reset() {
	*x = ComputationalCommitment{}
	mi := &file_zerone_knowledge_v1_types_proto_msgTypes[5]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *ComputationalCommitment) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ComputationalCommitment) ProtoMessage() {}

func (x *ComputationalCommitment) ProtoReflect() protoreflect.Message {
	mi := &file_zerone_knowledge_v1_types_proto_msgTypes[5]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ComputationalCommitment.ProtoReflect.Descriptor instead.
func (*ComputationalCommitment) Descriptor() ([]byte, []int) {
	return file_zerone_knowledge_v1_types_proto_rawDescGZIP(), []int{5}
}

func (x *ComputationalCommitment) GetWorkSpecHash() string {
	if x != nil {
...
func (x *ComputationalCommitment) GetAcceptanceHash() string {
	if x != nil {
...
func (x *ComputationalCommitment) GetInputRoot() string {
	if x != nil {
		return x.InputRoot
	}
	return ""
...
func (x *ComputationalCommitment) GetEnvironmentRoot() string {
	if x != nil {
...
func (x *ComputationalCommitment) GetArtifactRoot() string {
	if x != nil {
...
func (x *ComputationalCommitment) GetEvidenceRoot() string {
	if x != nil {
...
func (x *ComputationalCommitment) GetWorkReceiptHash() string {
	if x != nil {
...
type Fact struct {
	...
	// Present only on CLAIM_TYPE_COMPUTATIONAL facts. Copied byte-for-byte
	// from the accepted claim so settlement never trusts caller-supplied work
	// or receipt identifiers.
	ComputationalCommitment *ComputationalCommitment `protobuf:"bytes,76,opt,name=computational_commitment,json=computationalCommitment,proto3" json:"computational_commitment,omitempty"`
	unknownFields           protoimpl.UnknownFields
	sizeCache               protoimpl.SizeCache
}
...
func (x *Fact) GetComputationalCommitment() *ComputationalCommitment {
	if x != nil {
...
type Claim struct {
	...
	// Required for CLAIM_TYPE_COMPUTATIONAL and forbidden for every other
	// claim type. The verifier panel adjudicates the committed work while the
	// chain preserves only compact hashes/roots.
	ComputationalCommitment *ComputationalCommitment `protobuf:"bytes,25,opt,name=computational_commitment,json=computationalCommitment,proto3" json:"computational_commitment,omitempty"`
	unknownFields           protoimpl.UnknownFields
	sizeCache               protoimpl.SizeCache
}
...
func (x *Claim) GetComputationalCommitment() *ComputationalCommitment {
	if x != nil {
		return x.ComputationalCommitment
	}
	return nil
...
const file_zerone_knowledge_v1_types_proto_rawDesc = "" +
	...
	"\x04tags\x18\a \x03(\tR\x04tags\"\xa8\x02\n" +
	"\x17ComputationalCommitment\x12$\n" +
	...
	"\rartifact_root\x18\x05 \x01(\tR\fartifactRoot\x12#\n" +
	"\revidence_root\x18\x06 \x01(\tR\fevidenceRoot\x12*\n" +
	"\x11work_receipt_hash\x18\a \x01(\tR\x0fworkReceiptHash\"\x84\x17\n" +
	"\x04Fact\x12\x0e\n" +
	...
	"\x17falsification_predicate\x18K \x01(\tR\x16falsificationPredicate\x12g\n" +
	"\x18computational_commitment\x18L \x01(\v2,.zerone.knowledge.v1.ComputationalCommitmentR\x17computationalCommitment\"\xe0\x05\n" +
	...
	"\x17falsification_predicate\x18\x18 \x01(\tR\x16falsificationPredicate\x12g\n" +
	"\x18computational_commitment\x18\x19 \x01(\v2,.zerone.knowledge.v1.ComputationalCommitmentR\x17computationalCommitment\"\xaf\x04\n" +
...
var file_zerone_knowledge_v1_types_proto_msgTypes = make([]protoimpl.MessageInfo, 54)
var file_zerone_knowledge_v1_types_proto_goTypes = []any{
	...
	(*ComputationalCommitment)(nil),     // 27: zerone.knowledge.v1.ComputationalCommitment
	...
	(*VerificationRound)(nil),           // 42: zerone.knowledge.v1.VerificationRound
	(*CommitEntry)(nil),                 // 43: zerone.knowledge.v1.CommitEntry
	(*RevealEntry)(nil),                 // 44: zerone.knowledge.v1.RevealEntry
	(*VRFProof)(nil),                    // 45: zerone.knowledge.v1.VRFProof
	(*Domain)(nil),                      // 46: zerone.knowledge.v1.Domain
	(*ValidatorInfo)(nil),               // 47: zerone.knowledge.v1.ValidatorInfo
	(*ProvisionalChallenge)(nil),        // 48: zerone.knowledge.v1.ProvisionalChallenge
	(*DemandSignal)(nil),                // 49: zerone.knowledge.v1.DemandSignal
	(*KnowledgeBounty)(nil),             // 50: zerone.knowledge.v1.KnowledgeBounty
	(*CompletedRoundMeta)(nil),          // 51: zerone.knowledge.v1.CompletedRoundMeta
	(*MethodologyApplicationTrace)(nil), // 52: zerone.knowledge.v1.MethodologyApplicationTrace
	(*TraceChallenge)(nil),              // 53: zerone.knowledge.v1.TraceChallenge
	(*ReasoningStep)(nil),               // 54: zerone.knowledge.v1.ReasoningStep
	(*DriftDiagnosis)(nil),              // 55: zerone.knowledge.v1.DriftDiagnosis
	(*MethodologyChoice)(nil),           // 56: zerone.knowledge.v1.MethodologyChoice
	(*BeliefRevision)(nil),              // 57: zerone.knowledge.v1.BeliefRevision
	(*DialecticNode)(nil),               // 58: zerone.knowledge.v1.DialecticNode
	(*TraceVindication)(nil),            // 59: zerone.knowledge.v1.TraceVindication
	(*TraceDisproval)(nil),              // 60: zerone.knowledge.v1.TraceDisproval
	(*TraceReformulation)(nil),          // 61: zerone.knowledge.v1.TraceReformulation
	(*TraceDrift)(nil),                  // 62: zerone.knowledge.v1.TraceDrift
	(*ContrastivePair)(nil),             // 63: zerone.knowledge.v1.ContrastivePair
	(*TraceSchema)(nil),                 // 64: zerone.knowledge.v1.TraceSchema
	(*CorpusSelector)(nil),              // 65: zerone.knowledge.v1.CorpusSelector
	(*TrainingManifest)(nil),            // 66: zerone.knowledge.v1.TrainingManifest
	(*SeedStatus)(nil),                  // 67: zerone.knowledge.v1.SeedStatus
	(*RouteBCapabilities)(nil),          // 68: zerone.knowledge.v1.RouteBCapabilities
	(*Remediation)(nil),                 // 69: zerone.knowledge.v1.Remediation
	(*IncidentRecord)(nil),              // 70: zerone.knowledge.v1.IncidentRecord
	(*ModulePause)(nil),                 // 71: zerone.knowledge.v1.ModulePause
	(*PrivilegedAction)(nil),            // 72: zerone.knowledge.v1.PrivilegedAction
	(*PendingFactInjection)(nil),        // 73: zerone.knowledge.v1.PendingFactInjection
	nil,                                 // 74: zerone.knowledge.v1.Methodology.CrossMethodDiscountBpsEntry
	nil,                                 // 75: zerone.knowledge.v1.AgentCalibration.PerMethodEntry
}
var file_zerone_knowledge_v1_types_proto_depIdxs = []int32{
	...
	74, // 4: zerone.knowledge.v1.Methodology.cross_method_discount_bps:type_name -> zerone.knowledge.v1.Methodology.CrossMethodDiscountBpsEntry
	...
	27, // 10: zerone.knowledge.v1.Fact.computational_commitment:type_name -> zerone.knowledge.v1.ComputationalCommitment
	10, // 11: zerone.knowledge.v1.Augmentation.verdict:type_name -> zerone.knowledge.v1.AugmentationVerdict
	10, // 12: zerone.knowledge.v1.Augmentation.verdict_votes:type_name -> zerone.knowledge.v1.AugmentationVerdict
	75, // 13: zerone.knowledge.v1.AgentCalibration.per_method:type_name -> zerone.knowledge.v1.AgentCalibration.PerMethodEntry
	1,  // 14: zerone.knowledge.v1.Claim.status:type_name -> zerone.knowledge.v1.ClaimStatus
	4,  // 15: zerone.knowledge.v1.Claim.claim_type:type_name -> zerone.knowledge.v1.ClaimType
	23, // 16: zerone.knowledge.v1.Claim.relations:type_name -> zerone.knowledge.v1.ClaimRelation
	26, // 17: zerone.knowledge.v1.Claim.structure:type_name -> zerone.knowledge.v1.ClaimStructure
	27, // 18: zerone.knowledge.v1.Claim.computational_commitment:type_name -> zerone.knowledge.v1.ComputationalCommitment
	2,  // 19: zerone.knowledge.v1.VerificationRound.phase:type_name -> zerone.knowledge.v1.VerificationPhase
	43, // 20: zerone.knowledge.v1.VerificationRound.commits:type_name -> zerone.knowledge.v1.CommitEntry
	44, // 21: zerone.knowledge.v1.VerificationRound.reveals:type_name -> zerone.knowledge.v1.RevealEntry
	3,  // 22: zerone.knowledge.v1.VerificationRound.verdict:type_name -> zerone.knowledge.v1.Verdict
	7,  // 23: zerone.knowledge.v1.Domain.status:type_name -> zerone.knowledge.v1.DomainStatus
	22, // 24: zerone.knowledge.v1.MethodologyApplicationTrace.predecessor_edges:type_name -> zerone.knowledge.v1.FactRelation
	22, // 25: zerone.knowledge.v1.MethodologyApplicationTrace.descendant_edges:type_name -> zerone.knowledge.v1.FactRelation
	53, // 26: zerone.knowledge.v1.MethodologyApplicationTrace.challenges:type_name -> zerone.knowledge.v1.TraceChallenge
	0,  // 27: zerone.knowledge.v1.MethodologyApplicationTrace.status:type_name -> zerone.knowledge.v1.FactStatus
	59, // 28: zerone.knowledge.v1.MethodologyApplicationTrace.vindication:type_name -> zerone.knowledge.v1.TraceVindication
	60, // 29: zerone.knowledge.v1.MethodologyApplicationTrace.disproval:type_name -> zerone.knowledge.v1.TraceDisproval
	61, // 30: zerone.knowledge.v1.MethodologyApplicationTrace.reformulations:type_name -> zerone.knowledge.v1.TraceReformulation
	62, // 31: zerone.knowledge.v1.MethodologyApplicationTrace.drift_examples:type_name -> zerone.knowledge.v1.TraceDrift
	8,  // 32: zerone.knowledge.v1.MethodologyApplicationTrace.curriculum_tier:type_name -> zerone.knowledge.v1.CurriculumTier
	9,  // 33: zerone.knowledge.v1.MethodologyApplicationTrace.quality_tier:type_name -> zerone.knowledge.v1.TrainingQualityTier
	54, // 34: zerone.knowledge.v1.MethodologyApplicationTrace.reasoning_steps:type_name -> zerone.knowledge.v1.ReasoningStep
	56, // 35: zerone.knowledge.v1.MethodologyApplicationTrace.methodology_choice:type_name -> zerone.knowledge.v1.MethodologyChoice
	57, // 36: zerone.knowledge.v1.MethodologyApplicationTrace.belief_revisions:type_name -> zerone.knowledge.v1.BeliefRevision
	58, // 37: zerone.knowledge.v1.MethodologyApplicationTrace.dialectic_tree:type_name -> zerone.knowledge.v1.DialecticNode
	58, // 38: zerone.knowledge.v1.TraceChallenge.children:type_name -> zerone.knowledge.v1.DialecticNode
	11, // 39: zerone.knowledge.v1.ReasoningStep.step_inference:type_name -> zerone.knowledge.v1.StepInference
	12, // 40: zerone.knowledge.v1.ReasoningStep.verdict:type_name -> zerone.knowledge.v1.StepVerdict
	13, // 41: zerone.knowledge.v1.DriftDiagnosis.drift_kind:type_name -> zerone.knowledge.v1.DriftKind
	14, // 42: zerone.knowledge.v1.BeliefRevision.reason:type_name -> zerone.knowledge.v1.RevisionReason
	15, // 43: zerone.knowledge.v1.DialecticNode.role:type_name -> zerone.knowledge.v1.DialecticRole
	58, // 44: zerone.knowledge.v1.DialecticNode.children:type_name -> zerone.knowledge.v1.DialecticNode
	12, // 45: zerone.knowledge.v1.DialecticNode.node_verdict:type_name -> zerone.knowledge.v1.StepVerdict
	10, // 46: zerone.knowledge.v1.TraceReformulation.verdict:type_name -> zerone.knowledge.v1.AugmentationVerdict
	10, // 47: zerone.knowledge.v1.TraceDrift.verdict:type_name -> zerone.knowledge.v1.AugmentationVerdict
	55, // 48: zerone.knowledge.v1.TraceDrift.diagnosis:type_name -> zerone.knowledge.v1.DriftDiagnosis
	54, // 49: zerone.knowledge.v1.TraceDrift.drifter_steps:type_name -> zerone.knowledge.v1.ReasoningStep
	16, // 50: zerone.knowledge.v1.ContrastivePair.pair_type:type_name -> zerone.knowledge.v1.ContrastivePairType
	9,  // 51: zerone.knowledge.v1.CorpusSelector.min_quality_tier:type_name -> zerone.knowledge.v1.TrainingQualityTier
	8,  // 52: zerone.knowledge.v1.CorpusSelector.min_curriculum_tier:type_name -> zerone.knowledge.v1.CurriculumTier
	16, // 53: zerone.knowledge.v1.CorpusSelector.pair_type_filter:type_name -> zerone.knowledge.v1.ContrastivePairType
	65, // 54: zerone.knowledge.v1.TrainingManifest.corpus_selector:type_name -> zerone.knowledge.v1.CorpusSelector
	17, // 55: zerone.knowledge.v1.TrainingManifest.status:type_name -> zerone.knowledge.v1.ManifestStatus
	67, // 56: zerone.knowledge.v1.RouteBCapabilities.seed_status:type_name -> zerone.knowledge.v1.SeedStatus
	20, // 57: zerone.knowledge.v1.Remediation.type:type_name -> zerone.knowledge.v1.RemediationType
	18, // 58: zerone.knowledge.v1.IncidentRecord.severity:type_name -> zerone.knowledge.v1.IncidentSeverity
	19, // 59: zerone.knowledge.v1.IncidentRecord.status:type_name -> zerone.knowledge.v1.IncidentStatus
	69, // 60: zerone.knowledge.v1.IncidentRecord.remediations:type_name -> zerone.knowledge.v1.Remediation
	21, // 61: zerone.knowledge.v1.PrivilegedAction.type:type_name -> zerone.knowledge.v1.PrivilegedActionType
	38, // 62: zerone.knowledge.v1.AgentCalibration.PerMethodEntry.value:type_name -> zerone.knowledge.v1.AgentMethodStats
