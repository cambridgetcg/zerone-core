...
func TestNestedMsgTypesGogoResolvable(t *testing.T) {
	if gogoproto.MessageType("zerone.emergency.v1.Params") == nil {
		t.Fatal("zerone.emergency.v1.Params not in the gogo registry — MsgUpdateParams txs will fail to decode")
	}
}
