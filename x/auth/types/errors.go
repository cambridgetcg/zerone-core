...
var (
	...
	ErrKeyAuthorizationExpired = errors.Register(ModuleName, 31, "key-rotation authorization expired")
	ErrKeyAuthorizationTooFar  = errors.Register(ModuleName, 32, "key-rotation authorization expiry exceeds maximum TTL")
	ErrInvalidAuthorizationSig = errors.Register(ModuleName, 33, "invalid key-rotation authorization signature")
	ErrInvalidIdentityProof    = errors.Register(ModuleName, 34, "invalid identity-key proof")
	ErrInvalidNewKeyProof      = errors.Register(ModuleName, 35, "invalid new-key confirmation signature")
)
