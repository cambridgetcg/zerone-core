...
func TestNestedMsgTypesGogoResolvable(t *testing.T) {
	if gogoproto.MessageType("zerone.ibcratelimit.v1.Params") == nil {
		t.Fatal("zerone.ibcratelimit.v1.Params not in the gogo registry — MsgUpdateParams txs will fail to decode")
	}
}
