...
const (
	Query_RateLimit_FullMethodName  = "/zerone.ibcratelimit.v1.Query/RateLimit"
	Query_RateLimits_FullMethodName = "/zerone.ibcratelimit.v1.Query/RateLimits"
	Query_Params_FullMethodName     = "/zerone.ibcratelimit.v1.Query/Params"
)
...
//
// Query defines the ibcratelimit module Query service.
...
func (c *queryClient) RateLimits(ctx context.Context, in *QueryRateLimitsRequest, opts ...grpc.CallOption) (*QueryRateLimitsResponse, error) {
	...
	err := c.cc.Invoke(ctx, Query_RateLimits_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedQueryServer) RateLimits(context.Context, *QueryRateLimitsRequest) (*QueryRateLimitsResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method RateLimits not implemented")
}
...
func _Query_RateLimits_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Query_RateLimits_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var Query_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "zerone.ibcratelimit.v1.Query",
	...
	Metadata: "zerone/ibcratelimit/v1/query.proto",
}
