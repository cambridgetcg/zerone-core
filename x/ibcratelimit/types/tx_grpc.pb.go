...
const (
	Msg_AddRateLimit_FullMethodName    = "/zerone.ibcratelimit.v1.Msg/AddRateLimit"
	Msg_RemoveRateLimit_FullMethodName = "/zerone.ibcratelimit.v1.Msg/RemoveRateLimit"
	Msg_UpdateParams_FullMethodName    = "/zerone.ibcratelimit.v1.Msg/UpdateParams"
)
...
//
// Msg defines the ibcratelimit module Msg service (all governance-gated).
...
func (c *msgClient) AddRateLimit(ctx context.Context, in *MsgAddRateLimit, opts ...grpc.CallOption) (*MsgAddRateLimitResponse, error) {
	...
	err := c.cc.Invoke(ctx, Msg_AddRateLimit_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) RemoveRateLimit(ctx context.Context, in *MsgRemoveRateLimit, opts ...grpc.CallOption) (*MsgRemoveRateLimitResponse, error) {
	...
	err := c.cc.Invoke(ctx, Msg_RemoveRateLimit_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedMsgServer) AddRateLimit(context.Context, *MsgAddRateLimit) (*MsgAddRateLimitResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method AddRateLimit not implemented")
}
...
var Msg_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "zerone.ibcratelimit.v1.Msg",
	...
	Metadata: "zerone/ibcratelimit/v1/tx.proto",
}
