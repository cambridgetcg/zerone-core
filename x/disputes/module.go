...
import (
	...
	"github.com/zerone-chain/zerone/x/disputes/client/cli"
...
// BeginBlock handles begin-block logic: advance dispute phases based on deadlines.
func (am AppModule) BeginBlock(goCtx context.Context) error {
	ctx := sdk.UnwrapSDKContext(goCtx)
	currentBlock := uint64(ctx.BlockHeight())
	am.keeper.ProcessPhaseTransitions(ctx, currentBlock)
	return nil
}
