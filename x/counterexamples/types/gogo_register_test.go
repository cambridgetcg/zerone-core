...
func TestNestedMsgTypesGogoResolvable(t *testing.T) {
	if gogoproto.MessageType("zerone.counterexamples.v1.Params") == nil {
		t.Fatal("zerone.counterexamples.v1.Params not in the gogo registry — MsgUpdateParams txs will fail to decode")
	}
}
