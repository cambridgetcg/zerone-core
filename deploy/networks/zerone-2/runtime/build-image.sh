...
build_signed_artifact_auditor() {
  ...
  while IFS= read -r -d '' relative; do
    ...
    go.mod go.sum app x internal/accountingmigration internal/survivalmigration internal/recordmigration internal/reviewmigration internal/claimrecordmigration internal/fundsettlementmigration docs/swagger-ui \
