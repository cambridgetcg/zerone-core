...
> **Rehearsal reference, not live deployment authority.** No binary or command
> in this tree is authorized for `zerone-1` or the legacy
> `zerone-testnet-1` without that network's independently signed release packet
