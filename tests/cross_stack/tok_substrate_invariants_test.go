...
// Current scope: TC0–TC5 have behavioral tests split across this file and
// tok_substrate_tc4_test.go. TC6 lineage revenue distribution is not
// implemented. Repository hash scripts pin TOK_SUBSTRATE, USEFUL_WORK, and
// TRUTH_SEEKING independently; there is no universal ToK doctrine meta-test.
