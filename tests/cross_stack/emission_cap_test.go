...
// knowledge/tokens emissions that are inert by default. Every compiled
// runtime pathway gates through MintWithCap. The pre-H1 transaction-presence
// proposer mint is retired. InitChainer separately checks direct genesis supply.
// This
...
func TestEmissionCap_BootstrapClaimMintsOnDemand(t *testing.T) {
	...
	// participates in the shared cap budget used by every active mint source.
