...
log_result "  Reason: Requires Go 1.25.14, git clone, 'make install' — adds 5-10 min"
...
log_result ""
log_result "5. VALIDATOR-GUIDE.md: Go version must match the repository's exact supported patch"
log_result "   go.mod specifies go 1.25.14; active build and operator docs should match"
log_result ""
