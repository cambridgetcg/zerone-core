...
log_result "  Reason: Requires Go 1.25.12, git clone, 'make install' — adds 5-10 min"
...
log_result "   go.mod specifies go 1.25.12; active build and operator docs should match"
log_result ""
